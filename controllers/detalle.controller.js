...
const mostrarProductosRelacionados = (
  nombre,
  precio,
  descripcion,
  imagen,
  ...
  try {
    ...
    if (
      ...
      clientServices
        ...
        .then((data) => {
          data.forEach(
            ({ nombre, precio, descripcion, imagen, id, categoria }) => {
              //Imprimir datos en el index
              if (
                categoria === "Star wars" &&
                categoriaSolicitada === "Star wars" &&
                idProductoVisto != id
              ) {
                const nuevoProducto = mostrarProductosRelacionados(
                  nombre,
                  precio,
                  descripcion,
                  imagen,
